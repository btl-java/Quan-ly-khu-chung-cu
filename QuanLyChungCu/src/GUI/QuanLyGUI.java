...
public final class QuanLyGUI extends javax.swing.JFrame {
    ...
    private void showCanHoDaBan(){
        try {
            ...
            txtTongDoanhThu.setText(String.valueOf(ThongTinMuaBanBLL.doanhThu()));
    ...
    private void initComponents() {
        ...
        cbbMaKhu.setBackground(new java.awt.Color(240, 240, 240));
        ...
        cbbMaCanHo.setBackground(new java.awt.Color(240, 240, 240));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel15Layout.createSequentialGroup()
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel15Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtDiaChiKhachHang, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 171, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel15Layout.createSequentialGroup()
                        .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel15Layout.createSequentialGroup()
                                ...
                                .addGap(56, 56, 56)))
                        .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbbMaCuDanMuaBan, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtSoPhong, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel15Layout.createSequentialGroup()
                        .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel44)
                            .addComponent(cbbMaKhuMb, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)))
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel15Layout.createSequentialGroup()
                        .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        tblMuaBan.setPreferredSize(new java.awt.Dimension(20, 20));
        ...
        btnLuuMuaBan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLuuMuaBanActionPerformed(evt);
            }
        });

        btnXoaMuaBan.setText("xóa");
        btnXoaMuaBan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnXoaMuaBanActionPerformed(evt);
            }
        });
        ...
        jPanel16Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel16Layout.createSequentialGroup()
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnLuuMuaBan, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
        ...
        pnThongTinLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnThongTinLayout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(jScrollPane6, javax.swing.GroupLayout.DEFAULT_SIZE, 1070, Short.MAX_VALUE)
        );
...
//       test.setVisible(true);
    ...
    private void btXoa_NVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoa_NVActionPerformed
        if(TaiKhoanBLL.checkEmpty()){
            ...
            if(txbTenTK_NV.getText().length()>25 && txbTenTK_NV.getText().equals("")){
                JOptionPane.showMessageDialog(this,"Chọn dòng trước khi xóa!","Notification",JOptionPane.ERROR_MESSAGE);
            }else{
        ...
        try{
            if(!RegexExpression.checkUserName(txbTenTK_NV.getText())) {
                ...
                if(TaiKhoanBLL.insert(txbTenTK_NV.getText(),txbMK_NV.getText())){
                    show_TaiKhoan();
                    JOptionPane.showMessageDialog(null,"Thêm thành công!","Notification",JOptionPane.INFORMATION_MESSAGE);
                    clearAllControl_TaiKhoanNV();
                }else{
                    JOptionPane.showMessageDialog(null,"Không thêm được!","Notification",JOptionPane.ERROR_MESSAGE);
                }
            }
        }catch(HeadlessException e){
            JOptionPane.showMessageDialog(null,"Vui lòng không nhập mã trùng!","Notification",JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btTiepTucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btTiepTucActionPerformed
        XacNhanTTTKGUI xn = new XacNhanTTTKGUI(this, true);
        xn.setVisible(true);
        if(xn.checkAccountManager() && xn.checkEvent){ // if true info and event click Save, not Cancle or Close
    ...
    private void btnXoaMuaBanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaMuaBanActionPerformed
       ImageIcon icon=new ImageIcon("Images/loi.png");
        if(DAL.QuanLyHopDongDAL.kiemTraTonTai(txtMaHopDong.getText())==false) {
            ...
            int ref= JOptionPane.showConfirmDialog(null,
                "Bạn có chắc muốn xóa mã ["+txtMaHopDong.getText()+"] ?",
                "Xác nhận xóa",
                JOptionPane.YES_NO_OPTION,
                JOptionPane.QUESTION_MESSAGE,icon);
            if (ref==JOptionPane.YES_NO_OPTION) {
    ...
    private void btnLuuMuaBanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuMuaBanActionPerformed
       if(DAL.QuanLyHopDongDAL.kiemTraTonTai(txtMaHopDong.getText()) && DAL.QuanLyHopDongDAL.kiemTraTonTaiMaCanHO(cbbMaCanHoMuaBan.getSelectedItem()+"")){
